...
**posters**: Posters should be one page in A0 format (plus 1 page abstract).
...
Authors using LaTeX can download the needed macros at Springer-Verlag site.
Papers must respect the page limits announced above; full proofs and additional material may appear in a clearly marked technical appendix which can be read by the reviewers.

Authors are invited to submit original research papers through the EasyChair submission system: _link available soon_.
